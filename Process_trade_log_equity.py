...
def preprocessing(df , position_capital=100000):
    ...
    entry_date_map = {'e.date': 'entry_date', 'entrydate': 'entry_date' , 'date':'entry_date' , 'Entry_date':'entry_date', 'Time of Entry':'entry_date' , 'Time_of_Entry':'entry_date' , 'entry time':'entry_date' , 'Entry_time':'entry_date' ,'entry_time':'entry_date' , 'Start Time':'entry_date'  }
    exit_date_map = {'ex. date': 'exit_date', 'exit_ date': 'exit_date' , 'exitdate': 'exit_date' , 'Exit_date':'exit_date' , 'Time of Exit':'exit_date' , 'Time_of_Exit':'exit_date' , 'Exit time':'exit_date' , 'Exit_time':'exit_date' , 'exit_time':'exit_date' , 'End Time':'exit_date' }
